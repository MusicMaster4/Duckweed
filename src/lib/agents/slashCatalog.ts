...
const FALLBACKS: Record<AgentId, { name: string; description: string }[]> = {
  claude: [
    ...
    { name: "/hooks", description: "Inspect configured hooks" },
    { name: "/skills", description: "Inspect and invoke installed skills" },
    { name: "/agents", description: "Manage subagents" },
    { name: "/workflows", description: "Inspect background workflows" },
    { name: "/rewind", description: "Restore a previous conversation or file checkpoint" },
