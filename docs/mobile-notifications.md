...
or the desktop app receives any interaction during that interval, no
...
Focusing or hovering over Duckweed, switching tabs or panes, typing, clicking,
or scrolling all count as activity. The Android companion also suppresses and marks as read a
